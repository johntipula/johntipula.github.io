(function () {
    ...
    try {
        ...
        O = function () {
            H=[M(5,5,7,"fff"),M(20,5,7,"fff"),M(35,5,7,"fff"),M(50,5,7,"fff"),M(50,20,7,"fff"),M(50,35,7,"fff"),M(50,50,7,"fff"),M(48,65,7,"fff"),M(36,76,7,"fff"),M(20,80,7,"fff"),M(5,80,7,"fff"),M(74,20,7,"fff"),M(70,35,7,"fff"),M(70,50,7,"fff"),M(74,65,7,"fff"),M(85,77,7,"fff"),M(100,80,7,"fff"),M(115,77,7,"fff"),M(126,20,7,"fff"),M(130,35,7,"fff"),M(130,50,7,"fff"),M(126,65,7,"fff"),M(85,8,7,"fff"),M(100,5,7,"fff"),M(115,8,7,"fff"),M(150,5,7,"fff"),M(150,20,7,"fff"),M(150,35,7,"fff"),M(150,50,7,"fff"),M(150,65,7,"fff"),M(150,80,7,"fff"),M(165,43,7,"fff"),M(180,43,7,"fff"),M(195,43,7,"fff"),M(210,5,7,"fff"),M(210,20,7,"fff"),M(210,35,7,"fff"),M(210,50,7,"fff"),M(210,65,7,"fff"),M(210,80,7,"fff"),M(230,5,7,"fff"),M(230,20,7,"fff"),M(230,35,7,"fff"),M(230,50,7,"fff"),M(230,65,7,"fff"),M(230,80,7,"fff"),M(245,28,7,"fff"),M(260,43,7,"fff"),M(275,58,7,"fff"),M(290,5,7,"fff"),M(290,20,7,"fff"),M(290,35,7,"fff"),M(290,50,7,"fff"),M(290,65,7,"fff"),M(290,80,7,"fff"),];
            var a = K();
            x = a[0];
            y = a[1];
            z = a[2];
